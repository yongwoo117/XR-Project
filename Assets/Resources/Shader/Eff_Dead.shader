...
Shader "Team777/Effect_Dead"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin]_intencity("intencity", Float) = 1
		_Color("Color", Color) = (1,0,0,0)
		_main01("main01", 2D) = "white" {}
		_blur01("blur01", 2D) = "white" {}
		_interval("interval", Float) = 0.05
		_control("control", Range( 0 , 1)) = 0
		_noise("noise", Range( 0 , 1)) = 0.7391768
		[ASEEnd][Toggle]_ParticleSwitch("Particle Switch", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 tex2DNode12 = tex2D( _main01, texCoord15 );
				float4 texCoord23 = IN.ase_texcoord3;
				texCoord23.xy = IN.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float lerpResult20 = lerp( texCoord23.y , tex2D( _blur01, texCoord23.xy ).r , _noise);
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( tex2DNode12 + ( _intencity * _Color * step( lerpResult20 , ( (( _ParticleSwitch )?( texCoord23.z ):( _control )) + _interval ) ) ) ).rgb;
				float Alpha = ( tex2DNode12.a * step( (( _ParticleSwitch )?( texCoord23.z ):( _control )) , lerpResult20 ) );
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				surfaceDescription.Alpha = ( tex2DNode12.a * step( (( _ParticleSwitch )?( texCoord23.z ):( _control )) , lerpResult20 ) );
...
/*ASEBEGIN
Version=18935
1008;73;1118;753;1925.068;233.0778;1.595004;True;False
Node;AmplifyShaderEditor.TextureCoordinatesNode;23;-1573.45,445.0001;Inherit;False;0;-1;4;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;27;-1228.255,275.7726;Inherit;False;Property;_noise;noise;6;0;Create;True;0;0;0;False;0;False;0.7391768;0.7391768;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;19;-1242.266,360.8625;Inherit;True;Property;_blur01;blur01;3;0;Create;True;0;0;0;False;0;False;-1;2fdb70ac66273b8478e02934bba10fc0;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;22;-1358.133,643.1364;Inherit;False;Property;_control;control;5;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;20;-872.7556,350.0313;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ToggleSwitchNode;32;-973.5153,651.5016;Inherit;False;Property;_ParticleSwitch;Particle Switch;7;0;Create;True;0;0;0;False;0;False;0;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;15;-1206.12,-470.6287;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;12;-909.9962,-476.1911;Inherit;True;Property;_main01;main01;2;0;Create;True;0;0;0;False;0;False;-1;b94a9dc05abe1fe42aef9368957612cc;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.StepOpNode;29;-531.1161,420.1567;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;30;-218.827,219.1777;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;31;-290.4211,-403.086;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.StepOpNode;25;-548.3685,168.3006;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;16;-954.1365,-132.8238;Inherit;False;Property;_Color;Color;1;0;Create;True;0;0;0;False;0;False;1,0,0,0;1,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;17;-928.3212,-238.5302;Inherit;False;Property;_intencity;intencity;0;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;26;-816.4533,176.9892;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;21;-1115.708,153.2563;Inherit;False;Property;_interval;interval;4;0;Create;True;0;0;0;False;0;False;0.05;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;18;-460.0468,-208.1693;Inherit;True;3;3;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=C5F4D0DA82A4485024A76E0F8972D61C997EFB77