...
Shader "Team777/Slash"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin]_trail09("trail09", 2D) = "white" {}
		_inten("inten", Float) = 1
		_color("color", Color) = (1,0,0,0)
		_Float1("Float 1", Range( 0 , 1)) = 0
		[ASEEnd][Toggle]_particleSwitch("particle Switch", Float) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 tex2DNode11 = tex2D( _trail09, texCoord28.xy );
				float lerpResult27 = lerp( tex2DNode11.r , 0.0 , step( tex2DNode11.g , (0.0 + ((( _particleSwitch )?( texCoord28.z ):( _Float1 )) - 0.0) * (1.0 - 0.0) / (1.0 - 0.0)) ));
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( ( _inten * _color ) * IN.ase_color ).rgb;
				float Alpha = ( IN.ase_color.a * lerpResult27 );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float3 texCoord28 = IN.ase_texcoord2.xyz;
				texCoord28.xy = IN.ase_texcoord2.xyz.xy * float2( 1,1 ) + float2( 0,0 );
				float4 tex2DNode11 = tex2D( _trail09, texCoord28.xy );
				float lerpResult27 = lerp( tex2DNode11.r , 0.0 , step( tex2DNode11.g , (0.0 + ((( _particleSwitch )?( texCoord28.z ):( _Float1 )) - 0.0) * (1.0 - 0.0) / (1.0 - 0.0)) ));
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float3 texCoord28 = IN.ase_texcoord.xyz;
				texCoord28.xy = IN.ase_texcoord.xyz.xy * float2( 1,1 ) + float2( 0,0 );
				float4 tex2DNode11 = tex2D( _trail09, texCoord28.xy );
				float lerpResult27 = lerp( tex2DNode11.r , 0.0 , step( tex2DNode11.g , (0.0 + ((( _particleSwitch )?( texCoord28.z ):( _Float1 )) - 0.0) * (1.0 - 0.0) / (1.0 - 0.0)) ));
				
				surfaceDescription.Alpha = ( IN.ase_color.a * lerpResult27 );
        ...
        Pass
        {
			...
			{
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float3 texCoord28 = IN.ase_texcoord1.xyz;
				texCoord28.xy = IN.ase_texcoord1.xyz.xy * float2( 1,1 ) + float2( 0,0 );
				float4 tex2DNode11 = tex2D( _trail09, texCoord28.xy );
				float lerpResult27 = lerp( tex2DNode11.r , 0.0 , step( tex2DNode11.g , (0.0 + ((( _particleSwitch )?( texCoord28.z ):( _Float1 )) - 0.0) * (1.0 - 0.0) / (1.0 - 0.0)) ));
...
/*ASEBEGIN
Version=18935
466;73;987;635;1410.635;763.823;2.405759;True;False
Node;AmplifyShaderEditor.RangedFloatNode;18;-844.2314,256.6196;Inherit;False;Property;_Float1;Float 1;3;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;28;-705.3709,-27.02633;Inherit;False;0;-1;3;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ToggleSwitchNode;30;-524.008,285.6401;Inherit;False;Property;_particleSwitch;particle Switch;4;0;Create;True;0;0;0;False;0;False;1;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TFHCRemapNode;17;-239.2341,267.186;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0;False;4;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;11;-375,-14.5;Inherit;True;Property;_trail09;trail09;0;0;Create;True;0;0;0;False;0;False;-1;67b411193c4d7784ba54777694cd4916;67b411193c4d7784ba54777694cd4916;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.StepOpNode;29;34.40334,268.8834;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.VertexColorNode;31;278.8235,-70.85606;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.LerpOp;27;288.476,146.1067;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;13;-170,-318.5;Inherit;False;Property;_inten;inten;1;0;Create;True;0;0;0;False;0;False;1;20;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;12;-198,-201.5;Inherit;False;Property;_color;color;2;0;Create;True;0;0;0;False;0;False;1,0,0,0;0.3066038,0.5163348,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;33;547.6234,31.54398;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;14;53,-181.5;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;32;541.2233,-190.856;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;2;804.4498,-178.31;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;3;Team777/Slash;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;2;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;2;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;5;False;-1;10;False;-1;1;1;False;-1;10;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForwardOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;22;Surface;1;638029472135063505;  Blend;0;0;Two Sided;0;638029484055624632;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;0;0;DOTS Instancing;0;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,-1;0;  Type;0;0;  Tess;16,False,-1;0;  Min;10,False,-1;0;  Max;25,False,-1;0;  Edge Length;16,False,-1;0;  Max Displacement;25,False,-1;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;True;True;False;True;True;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=7DA782E142780D6876D034627B058F4A973F46DD